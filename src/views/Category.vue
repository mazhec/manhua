<template>
  <div class="container">
    ...
    <div class="category-list">
      <div class="category-item" :style="getHeightAndWidth" v-for="(category,index) in categoryList" :key="index">
...
<script>
  ...
  export default {
    name:'',
        ...
        mounted(){
          this.getHeightAndWidth.height = parseInt((window.innerWidth)/3) + 'px';
          this.getHeightAndWidth.width = parseInt((window.innerWidth)/3) + 'px';
